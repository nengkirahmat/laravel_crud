...
<div class="card col-md-12 mt-3">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control datepicker @error('tgl_lahir') is-invalid @enderror" name="tgl_lahir" placeholder="yyyy-mm-dd" value="{{old('tgl_lahir')}}" id="tgl_lahir">
  @error('tgl_lahir')
  <div class="invalid-feedback">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{old('username')}}" minlength="4" id="username" placeholder="username">
  @error('username')
  <div class="invalid-feedback">
    {{$message}}
  </div>
